...
CACHE_DIR = # INSERT CACHE DIRECTORY

INPUT_CSV = "lalm_relationships.csv"
OUTPUT_CSV = "lalm_relationships_predictions_few_shot.csv"
AUDIO_DIR = ""
...
RELATIONSHIPS = [
    'stranger', 'friends', 'family-members', 'coworkers',
    'dating/spouse/romantic_partner', 'classmates',
    'roommates', 'neighbors'
]
...
SYSTEM ROLE: 
You are an expert in paralinguistic analysis. Your goal is to classify the relationship between two people engaged in a naturalistic conversation.

TASK: 
Analyze the provided audio recording of a naturalistic conversation between two speakers. Your task is to classify the relationship type based on the categories listed below:
...
INSTRUCTIONS:
- You must provide an explanation of your observations and thought-process first. 
- Observe both the auditory and semantic/contextual characteristics of the interaction to inform your decision, then provide the final label.
- Do not repeat or reuse the explanations from the examples. Your explanation must be original and based solely on the audio provided.

RESPONSE FORMAT:
Explanation: [2-3 sentences detailing your observations and reasoning.]
Label: [Select one category from the RELATIONSHIP TYPES listed above.]

RESPONSE EXAMPLES:
Example 1
Explanation: The speakers share biographical childhood details in a polite and introductory manner, lacking any shared shorthand or intimate knowledge of each other's family backgrounds. The conversational rhythm is structured and careful, as if both parties are navigating a first-time meeting without prior context.
Label: stranger

Example 2
Explanation: The interaction is high-energy and filled with casual laughter as the speakers discuss travel dreams and personal preferences with great enthusiasm. Their speech is characterized by spontaneous overlaps and a lack of professional formality, indicating an established personal bond where they feel comfortable expressing opinions freely.
Label: friends

Example 3
Explanation: The speakers reminisce about their shared upbringing, mentioning specific relatives and childhood events with a high level of vocal familiarity. The conversation sounds deeply integrated into a domestic setting with a relaxed, non-projected cadence typical of people sharing a long-term family history.
Label: family-members

Example 4
Explanation: The dialogue is task-oriented and professional, focusing on workplace qualities and experiences with clear, respectful turn-taking. The tone is structured and lacks the personal emotional intimacy found in social friendships, reflecting a relationship built around a shared professional environment.
Label: coworkers

Example 5
Explanation: One speaker, James, shares a long, detailed story about being an altar boy and childhood memories of Disneyland, while the partner provides constant, soft verbal "mhmms" and supportive prompts. The vocal intimacy and the patient, focused listening style reflect a deep, ongoing romantic connection.
Label: dating/spouse/romantic_partner

Example 6
Explanation: The speakers are collaboratively brainstorming a fitness challenge involving activities like climbing and spinning, specifically referring to one another as a "gym bro." The turn-taking is rhythmic and focused on the logistics of a shared peer project, consistent with a classmate dynamic.
Label: classmates

Example 7
Explanation: The conversation centers on the logistical and emotional transition of moving out of their parents' homes and gaining independence through school workshops and the FAFSA process. Their deep familiarity with each other's financial and family struggles highlights a relationship shaped by shared living transitions.
Label: roommates

Example 8
Explanation: The speakers exchange thoughts on local surroundings and neighborhood features with a friendly but socially distanced tone. They refer to specific street-level details and nearby residences, implying they live in close proximity to one another without sharing an integrated personal life.
Label: neighbors
"""
...
def parse_response(text):
    ...
    if label_match:
        ...
        for valid_label in RELATIONSHIPS:
...
def main():
    ...
    for model_name in models_to_run:
        ...
        if 'label' in df.columns:
            correct = (df[pred_col] == df['relationship_detail_a']).sum()
