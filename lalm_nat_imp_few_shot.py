...
OUTPUT_CSV = "lalm_nat_imp_predictions_few_shot.csv"
AUDIO_DIR = ""
...
RESPONSE EXAMPLES:
Example 1
Explanation: The interaction features spontaneous, mid-sentence laughter and natural "cooperative overlap" where speakers talk over each other to show agreement. Semantically, they are discussing mundane, fragmented topics without explaining background details, which confirms a real-life relationship with deep shared context rather than a performance.
Label: naturalistic

Example 2
The speakers exhibit a "ping-pong" turn-taking rhythm while role-playing as a modest tennis player and a charismatic tennis player. The content is "audience-facing," with speakers explicitly stating their specialized roles and the athletic setting to frame a specific fictional scene for a listener.
Label: improvised

Example 3
Explanation: The delivery lacks the characteristic "speech repairs" (like "um" or false starts) found in spontaneous thought, maintaining a steady, practiced tempo throughout. The semantic content is highly condensed and goal-oriented, focusing on a specific conflict or narrative hook that is established immediately to drive the improvised scenario.
Label: improvised

Example 4
Explanation: Auditory cues include frequent stammers and mid-sentence hesitations that reflect real-time cognitive processing. The speakers are engaged in low-stakes "small talk" about a routine activity, using pronouns and vague references that assume the other person already knows the full story, which is typical of naturalistic speech.
Label: naturalistic

Example 5
The prosody is exaggerated as the speakers role-play a kind-hearted doctor and a vivacious patient dealing with a surreal medical condition involving rhyming constraints and a "Subway sandwich cure." The vocal energy is consistently projected for a performance, and the characters explicitly detail the absurd rules of the scenario to establish the fictional context for an observer.
Label: improvised

Example 6
Explanation: There is significant "backchanneling" (vocalized nods like "yeah," "mm-hmm") that occurs in a non-rhythmic, organic way. The content is phatic—focused on maintaining a social bond rather than relaying a plot—and the speakers use a relaxed, "swallowed" articulation that lacks the clarity of an actor's projection.
Label: naturalistic
"""
